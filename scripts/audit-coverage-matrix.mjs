...
const COVERAGE = {
  ...
  61: { tier: 'HOOK-ENFORCED', mechanism: 'check_item_list_gap.sh + check_data_table_size_num_to_meta_width.sh(M16 + M23c)WARN(exit 0,非 block)+ audit-time grep backstop' },
