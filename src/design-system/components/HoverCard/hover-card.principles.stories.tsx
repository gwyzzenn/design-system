...
export const WhenToUse: Story = {
  ...
  render: () => (
    <div className="prose prose-sm max-w-prose">
      ...
      <ul>
        <li><strong>PersonNameCard</strong> — Person Name Card 場景</li>
        <li><strong>LinkPreview</strong> — Link Preview 場景</li>
        <li><strong>OverflowList</strong> — Overflow List 場景</li>
        <li><strong>RepoCard</strong> — Repo Card 場景</li>
      </ul>
