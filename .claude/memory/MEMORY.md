...
- [feedback_governance_counter_drift_sync_coverage.md](feedback_governance_counter_drift_sync_coverage.md) — 計數/編號 SSOT(checklist 項數/gate 題數/skill 數/M-rule 編號)最易漂移;必進 sync-governance-counters liveCountFiles 或改 pointer 不 hardcode;date-adjacent regex 誤配陷阱(2026-07-04 全系統健檢)
